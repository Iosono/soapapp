...
public final class SoapAPPContract {
    ...
    public static final class RicetteSaponi implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =  Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI);

        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_ID);
     ...
     */
    public static final class CoefficientiSaponificazione implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =  Uri.parse(SCHEME + AUTHORITY + COEFFICIENTI_SAPONIFICAZIONE);

        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + COEFFICIENTI_SAPONIFICAZIONE_ID);
     ...
     */
    public static final class RicetteSaponiTipiIngredienti implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_TIPI_INGREDIENTI);

        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_TIPI_INGREDIENTI_ID);
    ...
    public static final class RicetteSaponiMagazzino implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =  Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_MAGAZZINO);

        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_MAGAZZINO_ID);
     ...
     */
    public static final class RicetteSaponiMagazzinoRicetta implements BaseColumns {
        ...
        public static final Uri CONTENT_URI =  Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_MAGAZZINO_RICETTA);

        public static final Uri CONTENT_ID_URI_BASE
            = Uri.parse(SCHEME + AUTHORITY + RICETTE_SAPONI_MAGAZZINO_RICETTA_ID);
